...
- commit `76d1503` 已推送 GitHub `main` 並部署至 Contabo production。本機品質檢查為 `52 passed, 1 skipped`（本機缺少 LibreOffice），Ruff、Django system check、migration check 均通過；VPS 容器健康、DOCX/PDF smoke 與公開 health/readiness 均通過。
